    ...
    <div className='w-full min-h-screen relative bg-gray-100 overflow-hidden flex justify-center items-center flex-col py-10'>
      ...
      <h2 className='text-[150px] absolute font-bold opacity-10 mb-4'>PROJECT 1</h2>
        <div className='flex-1 text-start space-y-4'>
          ...
          <p className='text-gray-700'>Full building Construction with modern architectural design ensuring sustainable development and eco-friendly materials.</p>
      ...
      <div className='relative z-10 flex flex-col md:flex-row-reverse w-full max-w-6xl items-center justify-between  overflow-hidden px-6 py-8 md:px-12 md:py-16'>
      ...
      <div className='relative z-10 flex flex-col md:flex-row w-full max-w-6xl items-center justify-between  overflow-hidden px-6 py-8 md:px-12 md:py-16'>
